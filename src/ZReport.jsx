...
const S = {
  overlay: { position:"fixed", inset:0, background:"rgba(5,8,16,0.97)", zIndex:1000, display:"flex", flexDirection:"column", fontFamily:"'Plus Jakarta Sans',sans-serif", color:"#fff", overflow:"auto" },
  ...
  btn:     { background:"linear-gradient(90deg,#F59E0B,#F97316)", border:"none", borderRadius:8, padding:"8px 14px", color:"#050810", cursor:"pointer", fontSize:12, fontWeight:700, fontFamily:"'Plus Jakarta Sans',sans-serif" },
  ...
  dateInput: { background:"#080c10", border:"1px solid #161b22", borderRadius:8, padding:"8px 12px", color:"#fff", fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:13, colorScheme:"dark" },
          ...
          <div onClick={e=>e.stopPropagation()} style={{background:"#0d1117",border:"1px solid #21262d",borderRadius:16,padding:"30px",maxWidth:520,width:"90%"}}>
            ...
            <div style={{marginBottom:14}}>
              ...
              <textarea value={emailTo} onChange={e=>setEmailTo(e.target.value)}
                ...
                rows={2}
                style={{width:"100%",background:"#0a0e16",border:"1px solid #21262d",borderRadius:8,padding:"10px 12px",color:"#fff",fontSize:13,fontFamily:"'Plus Jakarta Sans',sans-serif",resize:"vertical"}}/>
