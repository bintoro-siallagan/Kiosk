          ...
          <div style={S.cashTransparencyBox}>
            ...
            {state.cashChange > 0 && (
              <div style={S.cashTransparencyChange}>
                <span style={S.cashTrChangeLabel}>Change Anda</span>
...
const S = {
  ...
  conn: {
    position:"fixed", top:14, right:14, fontSize:10, padding:"4px 12px",
    border:"1px solid", borderRadius:100,
    background:"rgba(13,17,23,0.78)",
    backdropFilter:"blur(8px)", WebkitBackdropFilter:"blur(8px)",
    display:"flex", alignItems:"center", gap:6, zIndex:100,
    fontFamily:"'Geist Mono',monospace", letterSpacing:0.5, fontWeight:700,
  },
  connDot: { width:6, height:6, borderRadius:"50%", boxShadow:"0 0 8px currentColor" },
  ...
  cartTitleRow: { display:"flex", justifyContent:"space-between", alignItems:"baseline", marginBottom:24 },
  cartTitle: {
    fontSize:56, fontWeight:800, letterSpacing:-1.5, lineHeight:1,
    background:"linear-gradient(135deg,#F59E0B 0%,#fbbf24 50%,#F59E0B 100%)",
    WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text",
    filter:"drop-shadow(0 0 24px rgba(251,191,36,0.2))",
  },
  ...
  cartList: { display:"flex", flexDirection:"column", gap:12, marginBottom:32 },
  cartItem: {
    display:"flex", alignItems:"flex-start", gap:20, padding:"18px 24px",
  ...
  qrAmountBox: { marginTop:32, padding:"20px 40px",
    background: "radial-gradient(ellipse 60% 50% at 30% 20%, rgba(70,76,98,0.45) 0%, transparent 65%), radial-gradient(ellipse 55% 45% at 75% 80%, rgba(50,55,72,0.35) 0%, transparent 65%), linear-gradient(160deg,#12141c 0%,#181b25 50%,#22253a 100%)", border:"2px solid #F59E0B", borderRadius:16,
