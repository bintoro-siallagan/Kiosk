          ...
          <div style={{ animation:"fadeIn 0.2s ease" }}>
            ...
            {esbMenu.length === 0 && getStatus !== LOADING && (
              <div style={S.emptyState}>
                ...
                <div style={{ fontFamily:"'Inter',sans-serif", fontSize:22, letterSpacing:3, color:"#444", marginBottom:8 }}>
                  BELUM ADA DATA
                </div>
...
const S = {
  ...
  title:    { fontFamily:"'Inter',sans-serif", fontSize:22, letterSpacing:3, color:"#FF6B35" },
  ...
  sectionTitle:{ fontFamily:"'Inter',sans-serif", fontSize:20, letterSpacing:2, color:"#fff", marginBottom:4 },
  ...
  btnPrimary:  { background:"linear-gradient(90deg,#FF6B35,#FF3B30)", border:"none", borderRadius:10, padding:"10px 20px", color:"#fff", cursor:"pointer", fontSize:13, fontWeight:700, letterSpacing:1, fontFamily:"'Inter',sans-serif", display:"flex", alignItems:"center", gap:6 },
  ...
  btnImport:   { background:"linear-gradient(90deg,#00C896,#00a07a)", border:"none", borderRadius:10, padding:"10px 20px", color:"#fff", cursor:"pointer", fontSize:13, fontWeight:700, letterSpacing:1, fontFamily:"'Inter',sans-serif", display:"flex", alignItems:"center", gap:6 },
