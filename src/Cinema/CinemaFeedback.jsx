...
function Shell({ children }) {
  return (
    <div style={{ position: "fixed", inset: 0, background: "linear-gradient(160deg,#070b16 0%,#0d1424 50%,#121b35 100%)", color: "#e6edf3", fontFamily: "'Inter','SF Pro Display',system-ui,sans-serif", overflowY: "auto" }}>
      ...
      <div style={{ position: "relative", width: "min(100%, 520px)", margin: "0 auto" }}>{children}</div>
    </div>
  );
}
