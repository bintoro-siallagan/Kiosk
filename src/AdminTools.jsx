...
export default function AdminTools({ onBack, initialTab }) {
  ...
  const GROUPS = [
    ...
    { name: "Inventory & Procurement", icon: "🚚", module: "stock", ids: ["price_list", "goods_delivery", "goods_received", "stock_opname", "stock_transfer", "batch_tracking", "production", "demand_forecast", "auto_reorder", "sales_stock_sync", "simple_purchase", "purchase_return", "petty_cash", "purchase_invoice", "procurement_plus"] },
