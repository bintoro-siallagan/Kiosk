...
const RemoteOpsCommand            = lazy(() => import("./Admin/RemoteOpsCommand.jsx"));
...
// ── Styles ──
const S = {
  root: { fontFamily: "'Inter',sans-serif", background: "radial-gradient(ellipse 60% 50% at 30% 20%, rgba(70,76,98,0.45) 0%, transparent 65%), radial-gradient(ellipse 55% 45% at 75% 80%, rgba(50,55,72,0.35) 0%, transparent 65%), linear-gradient(160deg,#12141c 0%,#181b25 50%,#22253a 100%)", color: "#fff", minHeight: "100%", display: "flex", flexDirection: "column", position: "fixed", top: 0, left: 0, right: 0, bottom: 0, overflowY: "auto", zIndex: 9999 },
  ...
  return (
    <div style={S.root}>
      <div style={S.main}>
        ...
        {tab === "remote_ops_command" && <RemoteOpsCommand apiBase={API} />}
        ...
        {tab === "billing" && <AdminBilling apiBase={API} />}
