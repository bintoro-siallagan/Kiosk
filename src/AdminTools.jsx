...
export default function AdminTools({ onBack, initialTab }) {
  ...
  const GROUPS = [
    ...
    { name: "Inventory & Procurement", icon: "🚚", module: "stock", ids: ["price_list", "goods_delivery", "goods_received", "stock_opname", "simple_purchase", "petty_cash", "purchase_invoice", "procurement_plus"] },
