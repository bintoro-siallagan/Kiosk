...
export default function CommandOperation() {
  ...
  const load = useCallback(() => {
    fetch(`${API}/api/section/operation`).then(r => r.json()).then(setD).catch(e => setErr(String(e)));
  }, []);
...
const S = {
  ...
  row: { display: "flex", alignItems: "center", gap: 10, padding: "9px 0", borderBottom: "1px solid #1c1c1c" },
};
