...
const KB = {
  ...
  enterKey: { height:52, flex:2, background:"linear-gradient(90deg,#F59E0B,#F97316)", border:"none", borderRadius:10, color:"#050810", fontSize:14, fontWeight:700, letterSpacing:1, fontFamily:"'Inter',cursive" },
};
...
const P = {
  ...
  title:      { fontFamily:"'Inter',cursive", fontSize:22, letterSpacing:3, color:"#F59E0B" },
  ...
  codeText:   { fontFamily:"'Inter',cursive", fontSize:28, letterSpacing:6, color:"#fff", flex:1, textAlign:"center" },
  ...
  resultAmount:{ fontFamily:"'Inter',cursive", fontSize:22, color:"#34D399", letterSpacing:1, marginLeft:"auto", flexShrink:0 },
  ...
  applyBtn:   { flex:2, background:"linear-gradient(90deg,#34D399,#059669)", border:"none", borderRadius:12, padding:"16px", color:"#fff", fontSize:15, fontWeight:700, letterSpacing:1, fontFamily:"'Inter',cursive" },
