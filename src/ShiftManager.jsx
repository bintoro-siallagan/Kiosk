...
const S = {
  ...
  input:     {width:"100%",background:"#080c10",border:"1px solid #21262d",borderRadius:10,padding:"10px 14px",color:"#fff",fontSize:13,fontFamily:"'Plus Jakarta Sans',sans-serif"},
