...
const S = {
  root: { minHeight:"100vh", background: "radial-gradient(ellipse 70% 55% at 50% 38%, rgba(40,44,58,0.5) 0%, transparent 70%), linear-gradient(160deg,#08090f 0%,#11131c 50%,#1a1d29 100%)", color:"#fff", fontFamily:"'Inter',sans-serif" },
  ...
  title: { fontFamily:"'Inter',sans-serif", fontSize:24, letterSpacing:2, color:"#F59E0B", margin:0 },
  statusPill: { background:"color-mix(in srgb, var(--brand-primary,#FF6B35) 15%, transparent)", color:"#F59E0B", padding:"6px 12px",
    borderRadius:100, fontSize:11, fontWeight:700, letterSpacing:1 },
  main: { maxWidth:640, margin:"0 auto", padding:"24px 20px" },
  contextBox: { background: "rgba(255,255,255,0.025)", border:"1px solid #2a2a2a", borderRadius:12, padding:16, marginBottom:16 },
  ...
  cartList: { background: "rgba(255,255,255,0.025)", border:"1px solid #2a2a2a", borderRadius:12, padding:16, marginBottom:16 },
  ...
  totalBox: { background: "rgba(255,255,255,0.025)", border:"1px solid #F59E0B", borderRadius:12, padding:16, marginBottom:16 },
  totalRow: { display:"flex", justifyContent:"space-between", alignItems:"center" },
  totalAmount: { fontFamily:"'Inter',sans-serif", fontSize:32, color:"#F59E0B", letterSpacing:2 },
  taxNote: { fontSize:10, color:"#555", marginTop:2 },
  payInfo: { background: "rgba(255,255,255,0.025)", border:"1px solid #2a2a2a", borderRadius:12, padding:14, marginBottom:16 },
  ...
  error: { background: "rgba(255,255,255,0.025)", border:"1px solid #EF4444", color:"#FCA5A5",
