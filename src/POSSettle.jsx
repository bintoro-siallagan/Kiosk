...
const S = {
  ...
  title: { fontFamily:"'Montserrat',sans-serif", fontSize:24, letterSpacing:2, color:"#F59E0B", margin:0 },
  ...
  totalAmount: { fontFamily:"'Montserrat',sans-serif", fontSize:32, color:"#F59E0B", letterSpacing:2 },
