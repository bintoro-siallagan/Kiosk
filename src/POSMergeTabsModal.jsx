...
const S = {
  ...
  sourceId: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 22, color: "#F59E0B", letterSpacing: 1 },
  sourceMeta: { fontSize: 12, color: "#D1D5DB", marginTop: 2 },
  sourceTotal: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 22, color: "white" },
  ...
  targetId: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 18, color: "#F59E0B", letterSpacing: 1 },
  targetMeta: { fontSize: 11, color: "#D1D5DB", marginTop: 2 },
  targetTotal: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 18, color: "white" },
