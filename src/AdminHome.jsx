...
const S = {
  root: { minHeight: "100vh", background: "linear-gradient(160deg,#12141c 0%,#181b25 50%,#22253a 100%)", backgroundAttachment: "fixed", color: "#c3c4c9", fontFamily: "'Geist','Inter',system-ui,sans-serif", padding: "16px 28px 24px", boxSizing: "border-box" },
