...
// Inline styles untuk MenuPickerModal — full glass + brand-aware + readable on any tenant
const MP = {
  overlay: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 },
  panel: { width: '100%', maxWidth: 720, maxHeight: '95vh', background: 'linear-gradient(180deg, rgba(40,44,58,0.92) 0%, rgba(20,22,32,0.95) 100%)', backdropFilter: 'blur(40px) saturate(200%)', WebkitBackdropFilter: 'blur(40px) saturate(200%)', borderRadius: 28, border: '1px solid rgba(255,255,255,0.08)', display: 'flex', flexDirection: 'column', overflow: 'hidden', color: '#fff', fontFamily: "'Inter',sans-serif", boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.14), 0 24px 60px rgba(0,0,0,0.45)' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '18px 22px 14px', borderBottom: '1px solid rgba(255,255,255,0.06)' },
  headerLeft: { display: 'flex', alignItems: 'center', gap: 14, minWidth: 0, flex: 1 },
  itemEmoji: { fontSize: 38, filter: 'drop-shadow(0 4px 12px rgba(0,0,0,0.3))' },
  itemName: { fontSize: 18, fontWeight: 600, color: 'rgba(255,255,255,0.95)', letterSpacing: '-0.4px' },
  itemDesc: { fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 3 },
  basePrice: { fontSize: 16, fontWeight: 600, color: 'rgba(255,255,255,0.7)', fontFamily: "'Inter',sans-serif", fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.2px' },
  progressSection: { padding: '14px 22px 8px' },
  progressLabel: { display: 'flex', justifyContent: 'space-between', fontSize: 12, color: 'rgba(255,255,255,0.6)', marginBottom: 7 },
  extraBadge: { color: '#F59E0B', fontWeight: 500, fontVariantNumeric: 'tabular-nums' },
  progressTrack: { height: 4, borderRadius: 2, background: 'rgba(255,255,255,0.06)', overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 2, transition: 'width 0.3s cubic-bezier(.2,.8,.2,1), background 0.2s' },
  tabs: { display: 'flex', gap: 6, padding: '10px 22px 6px', overflowX: 'auto' },
  tab: { padding: '6px 14px', borderRadius: 999, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.025)', color: 'rgba(255,255,255,0.65)', fontSize: 12, fontWeight: 500, cursor: 'pointer', whiteSpace: 'nowrap', fontFamily: "'Inter',sans-serif", letterSpacing: '-0.1px', transition: 'all 0.18s ease' },
  tabActive: { background: 'radial-gradient(ellipse 90% 180% at 50% 100%, color-mix(in srgb, var(--brand-primary,#FF6B35) 55%, transparent), transparent 55%), linear-gradient(180deg, color-mix(in srgb, var(--brand-primary,#FF6B35) 38%, #1a1d29), color-mix(in srgb, var(--brand-secondary,#E55A2B) 30%, #0d0f14))', color: '#fff', textShadow: '0 1px 2px rgba(0,0,0,0.45)', borderColor: 'rgba(255,255,255,0.16)', fontWeight: 600, boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.22), 0 4px 12px color-mix(in srgb, var(--brand-primary,#FF6B35) 22%, transparent)' },
  grid: { flex: 1, overflowY: 'auto', padding: '12px 22px 14px', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: 10, alignContent: 'start' },
  optBtn: { position: 'relative', padding: '14px 12px', borderRadius: 14, border: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.025)', color: 'rgba(255,255,255,0.92)', cursor: 'pointer', textAlign: 'left', minHeight: 70, fontFamily: "'Inter',sans-serif", transition: 'all 0.18s cubic-bezier(.2,.8,.2,1)' },
  ...
  qtyMini: { width: 22, height: 22, borderRadius: 6, background: 'color-mix(in srgb, var(--brand-primary,#FF6B35) 22%, transparent)', color: '#fff', fontSize: 14, fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', userSelect: 'none', border: '1px solid color-mix(in srgb, var(--brand-primary,#FF6B35) 40%, transparent)' },
  selectedBar: { display: 'flex', flexWrap: 'wrap', gap: 6, padding: '8px 22px 4px', borderTop: '1px solid rgba(255,255,255,0.05)' },
  selectedChip: { padding: '5px 11px', borderRadius: 999, border: '1px solid', fontSize: 11, fontWeight: 500, color: '#fff', cursor: 'pointer', fontFamily: "'Inter',sans-serif", letterSpacing: '-0.1px' },
  footer: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 22px 18px', borderTop: '1px solid rgba(255,255,255,0.06)', gap: 12 },
  cancelBtn: { padding: '12px 18px', borderRadius: 14, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'rgba(255,255,255,0.7)', cursor: 'pointer', fontSize: 13, fontWeight: 500, whiteSpace: 'nowrap', fontFamily: "'Inter',sans-serif", letterSpacing: '-0.1px' },
  priceBreakdown: { textAlign: 'center', flex: 1, fontFamily: "'Inter',sans-serif" },
  addonLine: { fontSize: 11, color: 'rgba(255,255,255,0.45)', fontVariantNumeric: 'tabular-nums', marginBottom: 2 },
  totalLine: { fontSize: 20, fontWeight: 600, color: '#fff', fontFamily: "'Inter',sans-serif", fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.6px' },
  confirmBtn: { padding: '13px 22px', borderRadius: 14, border: '1px solid rgba(255,255,255,0.16)', background: 'radial-gradient(ellipse 90% 180% at 50% 100%, color-mix(in srgb, var(--brand-primary,#FF6B35) 60%, transparent), transparent 55%), linear-gradient(180deg, color-mix(in srgb, var(--brand-primary,#FF6B35) 38%, #1a1d29), color-mix(in srgb, var(--brand-secondary,#E55A2B) 30%, #0d0f14))', color: '#fff', textShadow: '0 1px 3px rgba(0,0,0,0.45)', fontSize: 14, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap', letterSpacing: '-0.2px', fontFamily: "'Inter',sans-serif", boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.22), 0 8px 24px color-mix(in srgb, var(--brand-primary,#FF6B35) 22%, transparent)' },
};
