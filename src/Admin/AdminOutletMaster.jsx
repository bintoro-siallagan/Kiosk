              ...
              <div key={o.id} style={{ background: "#0a0e16", border: "1px solid #161b22", borderTop: `2px solid ${st.c}`, borderRadius: 10, padding: "12px 14px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 10, color: "#5b6470", fontFamily: "'Space Mono',monospace" }}>{o.code} · {o.area}</div>
                  </div>
                  <button onClick={() => cycleStatus(o)} style={{ fontSize: 9, fontWeight: 700, color: st.c, background: st.c + "1f", border: `1px solid ${st.c}66`, borderRadius: 5, padding: "3px 8px", fontFamily: "'Space Mono',monospace", cursor: "pointer" }}>{st.l}</button>
                </div>
