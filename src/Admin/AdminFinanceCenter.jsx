        ...
        <div style={{ marginTop: 10 }}>
          {d.outlets.map((o, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 0" }}>
              ...
              <span style={{ width: 100, textAlign: "right", fontFamily: "'Geist Mono',monospace", fontSize: 12, color: "#cdd5df", flexShrink: 0 }}>{fmtRp(o.revenue_today)}</span>
            </div>
          ))}
        </div>
      </div>
...
function Row({ k, v, c }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", padding: "7px 0", borderBottom: "1px solid #161b22", fontSize: 13 }}>
      ...
      <b style={{ color: c || "#e6edf3", fontFamily: "'Geist Mono',monospace" }}>{v}</b>
    </div>
  );
}
