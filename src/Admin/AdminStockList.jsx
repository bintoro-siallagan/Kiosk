          ...
          <tbody>
            {items.map(it => (
              <tr key={it.sku} style={{ borderTop: "1px solid #161b22", fontSize: 12 }}>
                ...
                <td style={S.td}>
                  <span style={{ fontSize: 9, fontWeight: 700, color: it.color, background: it.color + "1f", border: `1px solid ${it.color}55`, borderRadius: 5, padding: "2px 7px", fontFamily: "'Space Mono',monospace" }}>{it.label}</span>
                </td>
              </tr>
            ))}
          </tbody>
