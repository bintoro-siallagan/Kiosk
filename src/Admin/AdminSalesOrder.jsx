              ...
              <div key={o.id} style={{ background: "#0a0e16", border: "1px solid #161b22", borderLeft: `3px solid ${st.c}`, borderRadius: 9, padding: "11px 14px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 10, color: "#5b6470", fontFamily: "'Space Mono',monospace" }}>{o.items.length} item · {o.payment_terms}</div>
                  </div>
                  <span style={{ fontSize: 9, fontWeight: 700, color: ct, fontFamily: "'Space Mono',monospace" }}>{o.customer_type.toUpperCase()}</span>
                  <span style={{ fontFamily: "'Space Mono',monospace", fontWeight: 700, color: "#a78bfa", width: 120, textAlign: "right" }}>{fmtRp(o.total)}</span>
