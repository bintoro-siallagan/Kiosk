...
const S = {
  ...
  title: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 36, color: "#F59E0B", letterSpacing: 2 },
  subtitle: { fontSize: 12, color: "#9CA3AF", marginTop: 4 },
  section: { display: "flex", flexDirection: "column", gap: 8 },
  fieldLabel: { fontSize: 11, color: "#F59E0B", letterSpacing: 1.5, fontWeight: 700 },
  ...
  modeBtnActive: { background: "rgba(245,158,11,0.10)", borderColor: "rgba(245,158,11,0.5)", color: "#F59E0B" },
  ...
  previewLabel: { fontSize: 12, fontWeight: 700, marginTop: 6, color: "#F59E0B" },
  previewMore: { display: "flex", alignItems: "center", justifyContent: "center", color: "#6B7280", fontSize: 12 },
  printBtn: { padding: "14px", borderRadius: 12, background: "linear-gradient(135deg, #F59E0B, #D97706)", border: "none", color: "#111", fontSize: 15, fontWeight: 800, cursor: "pointer", fontFamily: "inherit" },
...
const P = {
  ...
  printBtn: { padding: "10px 18px", borderRadius: 8, background: "#F59E0B", border: "none", color: "#111", fontSize: 13, fontWeight: 800, cursor: "pointer", fontFamily: "inherit" },
  ...
  cardHeader: { borderBottom: "2px dashed #F59E0B", paddingBottom: 8 },
  cardLogo: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: "#F59E0B", letterSpacing: 2 },
  ...
  cardTable: { padding: "8px 12px", background: "#F59E0B", color: "#111", borderRadius: 8 },
