...
const S = {
  ...
  title: { fontFamily: "'Inter', sans-serif", fontSize: 36, color: "var(--brand-primary,#FF6B35)", letterSpacing: 2 },
  subtitle: { fontSize: 12, color: "#9CA3AF", marginTop: 4 },
  section: { display: "flex", flexDirection: "column", gap: 8 },
  fieldLabel: { fontSize: 11, color: "var(--brand-primary,#FF6B35)", letterSpacing: 1.5, fontWeight: 700 },
  ...
  modeBtnActive: { background: "rgba(245,158,11,0.10)", borderColor: "rgba(245,158,11,0.5)", color: "var(--brand-primary,#FF6B35)" },
  ...
  previewLabel: { fontSize: 12, fontWeight: 700, marginTop: 6, color: "var(--brand-primary,#FF6B35)" },
...
const P = {
  ...
  printBtn: { padding: "10px 18px", borderRadius: 8, background: "var(--brand-primary,#FF6B35)", border: "none", color: "#111", fontSize: 13, fontWeight: 800, cursor: "pointer", fontFamily: "inherit" },
  ...
  cardHeader: { borderBottom: "2px dashed var(--brand-primary,#FF6B35)", paddingBottom: 8 },
  cardLogo: { fontFamily: "'Inter', sans-serif", fontSize: 28, color: "var(--brand-primary,#FF6B35)", letterSpacing: 2 },
  ...
  cardTable: { padding: "8px 12px", background: "var(--brand-primary,#FF6B35)", color: "#111", borderRadius: 8 },
