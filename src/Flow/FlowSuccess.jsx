  ...
  return (
    <div style={S.container}>
      <div style={S.celebration}>
        ...
        <div style={{...S.title, color: currentStep >= 3 ? "#F59E0B" : "#10B981"}}>
...
const S = {
  ...
  stepIconActive: { background: "rgba(245,158,11,0.15)", border: "1px solid rgba(245,158,11,0.4)", color: "#F59E0B" },
