              ...
              <div style={S.itemBody}>
                ...
                {c.addons?.toppings?.length > 0 && (
                  <div style={{ fontSize: 10, color: "#6B7280", marginTop: 2, lineHeight: 1.3 }}>
                    ...
                    {c.addonTotal > 0 && <span style={{ color: "#F59E0B" }}> (+{fIDR(c.addonTotal)})</span>}
                  </div>
                )}
              </div>
          ...
          <div style={S.appliedPromoCard}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {promoDisc > 0 ? (
                ...
                <div style={{ fontSize: 11, color: "#F59E0B", marginTop: 4 }}>BOGO · diskon dihitung server</div>
              ) : null}
            </div>
        ...
        <div style={S.section}>
          ...
          <div style={S.pointsCard}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
              ...
              <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 20, color: "#F59E0B" }}>
...
const S = {
  ...
  itemLineTotal: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 16, color: "#F59E0B", letterSpacing: 0.5, whiteSpace: "nowrap" },
  ...
  applyBtn: { padding: "11px 18px", borderRadius: 10, background: "#F59E0B", border: "none", color: "#000", fontSize: 13, fontWeight: 800, cursor: "pointer", fontFamily: "inherit" },
  softErr: { padding: "8px 12px", borderRadius: 8, background: "rgba(245,158,11,0.08)", color: "#F59E0B", fontSize: 12 },

  // Points
  pointsCard: { padding: "14px", borderRadius: 12, background: "#0d0d0d", border: "1px solid #2a2a2a" },
  pointsInput: { width: "100%", padding: "10px 14px", borderRadius: 10, background: "#000", border: "1px solid #2a2a2a", color: "white", fontSize: 14, fontWeight: 700, outline: "none", fontFamily: "inherit", boxSizing: "border-box" },
  quickPickBtn: { flex: 1, padding: "6px 4px", borderRadius: 8, background: "transparent", border: "1px solid #2a2a2a", color: "white", fontSize: 11, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" },
  ...
  qrAmount: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 44, color: "#F59E0B", letterSpacing: 1, marginTop: 8 },
