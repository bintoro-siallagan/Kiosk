...
const S = {
  ...
  errorSoft: { padding: "8px 12px", borderRadius: 8, background: "rgba(245,158,11,0.08)", color: "#F59E0B", fontSize: 12, marginBottom: 12 },
