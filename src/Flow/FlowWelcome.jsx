...
const S = {
  ...
  logo: { fontFamily: "'Inter', sans-serif", fontSize: 48, color: "var(--brand-primary,#FF6B35)", letterSpacing: 3 },
  tagline: { fontSize: 13, color: "#9CA3AF", marginTop: 4, letterSpacing: 0.5 },
  tableBadge: { display: "inline-block", marginTop: 12, padding: "6px 14px", borderRadius: 20, background: "rgba(245,158,11,0.10)", border: "1px solid rgba(245,158,11,0.3)", color: "var(--brand-primary,#FF6B35)", fontSize: 12, fontWeight: 600 },
  ...
  errorSoft: { padding: "8px 12px", borderRadius: 8, background: "rgba(245,158,11,0.08)", color: "var(--brand-primary,#FF6B35)", fontSize: 12, marginBottom: 12 },
