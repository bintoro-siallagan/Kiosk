...
export const GROUPS = [
  ...
  { name: "Operasi & Outlet", icon: "🛰️", module: "pos", ids: ["outlet_master", "staff", "checklist", "cashier_kpi", "gudang", "waste", "asset_maintenance", "quality", "incidents", "escalation", "cinema_ops", "cinema_ticketing", "cinema_box_office", "cinema_validate", "compliance", "document_hub", "notif_center", "config", "audit"] },
