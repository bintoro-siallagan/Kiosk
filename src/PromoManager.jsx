                ...
                <div key={p.id} style={{...M.card,animation:"fadeUp 0.2s ease"}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:12}}>
                    ...
                    <div style={M.discBadge}>
                      ...
                      <div style={{fontSize:10,color:"#aaa",fontWeight:400,fontFamily:"'Plus Jakarta Sans',sans-serif"}}>{p.type==="percent"?"diskon":"potongan"}</div>
                    </div>
                  </div>
...
const M = {
  ...
  input:     {background:"#080c10",border:"1px solid #21262d",borderRadius:10,padding:"10px 14px",color:"#fff",fontSize:14,fontFamily:"'Plus Jakarta Sans',sans-serif"},
